...
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2025-01-01T15:58:11.540187500+02:00[Africa/Cairo]", comments = "Generator version: 7.10.0")
public class UserUpdate {
  ...
  @Schema(name = "password", description = "The updated password for the user", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  ...
  @Schema(name = "mobileNumber", description = "The updated mobile number of the user", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  ...
  @Schema(name = "role", description = "The updated role of the user", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("role")
  ...
  @Schema(name = "status", description = "The updated status of the user account", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("status")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, userName, email, password, mobileNumber, role, status);
  }
